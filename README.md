...
Необходимо реализовать системы для автоматизации работы сберегательного банка. В системе должно быть 3 типа пользователей: клиент, менеджер и администратор.
